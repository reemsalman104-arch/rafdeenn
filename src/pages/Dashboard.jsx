  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.sidebar}>
        ...
        <button
          style={{ ...styles.sideBtn, background: "#dc2626", color: "#fff", marginTop: 40 }}
          onClick={() => {
            localStorage.clear();
          ...
          <>
            ...
            <div style={{ display: "grid", gap: 24 }}>
              {users.map((user, index) => (
                <div key={index} style={{ background: "#1e1e1e", borderRadius: 12, boxShadow: "0 2px 12px #0007", padding: 24, display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", border: "1px solid #22c55e", gap: 16 }}>
                  <div style={{ flex: 1, minWidth: 120 }}><b style={{ color: "#22c55e" }}>الاسم:</b> {user.name}</div>
                  <div style={{ flex: 1, minWidth: 120 }}><b style={{ color: "#22c55e" }}>الإيميل:</b> {user.email}</div>
                  <div style={{ flex: 1, minWidth: 120 }}><b style={{ color: "#22c55e" }}>الرقم:</b> {user.phone}</div>
                  <div style={{ flex: 1, minWidth: 120 }}><b style={{ color: "#22c55e" }}>عدد الجوائز:</b> {user.prizes}</div>
                  <div style={{ flex: 1, minWidth: 120 }}>
                    <b style={{ color: "#22c55e" }}>الحالة:</b> {editingIndex === index ? (
                      <select
                        value={newStatus}
          ...
          <>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              {sections.map((sec, index) => (
                <div key={index} style={{ ...styles.sectionItem, border: "1px solid #22c55e" }}>
                  <span>{sec}</span>
                  <button
                    style={styles.deleteBtn}
